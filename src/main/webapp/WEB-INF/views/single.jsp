...
<head>
    ...
    <link href="<c:url value="/resources/home/plugins/font-awesome-4.7.0/css/font-awesome.min.css"/>" rel="stylesheet"
          type="text/css">
    <link href="<c:url value="/resources/home/plugins/colorbox/colorbox.css"/>" rel="stylesheet" type="text/css">
    ...
    <link rel="stylesheet" type="text/css" href="<c:url value="/resources/home/styles/single_listing_styles.css"/>">
    <link rel="stylesheet" type="text/css" href="<c:url value="/resources/home/styles/single_listing_responsive.css"/>">
</head>
...
<div class="super_container">
                    ...
                    <div class="col main_nav_col d-flex flex-row align-items-center justify-content-start">
                        <div class="logo_container">
                            <div class="logo"><a href="/home"><img
                                    src="<c:url value="/resources/home/images/logo.png"/>"
                                    alt="">travelix</a></div>
                        </div>
    ...
    <div class="menu trans_500">
        <div class="menu_content d-flex flex-column align-items-center justify-content-center text-center">
            ...
            <div class="logo menu_logo"><a href="/home"><img src="<c:url value="/resources/home/images/logo.png"/>"
                                                             alt=""></a>
            </div>
            <ul>
    ...
    <div class="home">
        <div class="home_background parallax-window" data-parallax="scroll"
             data-image-src="<c:url value="/resources/home/images/single_background.jpg"/>"></div>
                            ...
                            <div class="search_tabs_container">
                                <div class="search_tabs d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
                                    <div class="search_tab active d-flex flex-row align-items-center justify-content-lg-center justify-content-start">
                                        <img src="<c:url value="/resources/home/images/suitcase.png"/>" alt=""><span>tours</span>
                                    </div>
                            ...
                            <div class="hotel_info">
                                ...
                                <div class="hotel_title_container d-flex flex-lg-row flex-column">
                                    <div class="hotel_title_content">
                                        <h1 class="hotel_title">${tour.tourName}</h1>
                                        ...
                                        <div class="hotel_location">${tour.tourAddress}</div>
                                    </div>
                                ...
                                <div class="hotel_image">
                                    <img src="<c:url value="/${tour.imageEntities.get(0).imageUrl}"/>" alt="">
                                ...
                                <div class="hotel_gallery">
                                    <div class="hotel_slider_container">
                                        <div class="owl-carousel owl-theme hotel_slider">
                                            ...
                                            <c:forEach var="image" items="${tour.imageEntities}">
                                                <!-- Hotel Gallery Slider Item -->
                                                <div class="owl-item">
                                                    <a class="colorbox cboxElement"
                                                       href="<c:url value="/${image.imageUrl}"/>">
                                ...
                                <div class="hotel_info_tags">
                                    <ul class="hotel_icons_list">
                                        ...
                                        <li class="hotel_icons_item"><img
                                                src="<c:url value="/resources/home/images/compass.png"/>" alt=""></li>
                                        <li class="hotel_icons_item"><img
                                                src="<c:url value="/resources/home/images/bicycle.png"/>" alt=""></li>
                                        <li class="hotel_icons_item"><img
                                                src="<c:url value="/resources/home/images/sailboat.png"/>" alt=""></li>
                                    </ul>
                                </div>
                        ...
                        <div class="rooms">
                                ...
                                <div class="row">
                                    <div class="col-lg-2">
                                        <div class="room_image"><img
                                                src="<c:url value="/resources/home/images/room_1.jpg"/>"
                            ...
                            <div class="room">
                                ...
                                <div class="row">
                                    <div class="col-lg-2">
                                        <div class="room_image"><img
                                                src="<c:url value="/resources/home/images/room_2.jpg"/>"
                            ...
                            <div class="reviews_container">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-1">
                                            <div class="review_image">
                                                <img src="<c:url value="/resources/home/images/review_1.jpg"/>"
                                ...
                                <div class="review">
                                    <div class="row">
                                        <div class="col-lg-1">
                                            <div class="review_image">
                                                <img src="<c:url value="/resources/home/images/review_2.jpg"/>"
...
<script src="<c:url value="/resources/home/plugins/parallax-js-master/parallax.min.js"/>"></script>
<script src="<c:url value="/resources/home/plugins/colorbox/jquery.colorbox-min.js"/>"></script>
