...
<div class="super_container">
    ...
    <div class="home">
        <div class="home_background parallax-window" data-parallax="scroll"
             data-image-src="<c:url value="/resources/home/images/about_background.jpg" />"></div>
                                        ...
                                        <div class="offers_image_container">
                                            ...
                                            <div class="offers_image_background"
                                                 style="background-image:url(<c:url
                                                         value="/${tour.imageEntities.get(0).imageUrl}"/>)"></div>
                                            <div class="offer_name"><a href="#">${tour.tourAddress}</a></div>
                                        </div>
                                    </div>
                                    <div class="col-lg-8">
                                        <div class="offers_content">
                                            <div class="offers_price">$${tour.tourPrice}<span>per night</span></div>
                                            ...
                                            <p class="offers_text">Suspendisse potenti. In faucibus massa. Lorem ipsum dolor
                                                sit amet, consectetur adipiscing elit. Nullam eu convallis tortor. Lorem
                                                ipsum dolor sit amet.</p>
                                            <div class="offers_icons">
                                                <ul class="offers_icons_list">
                                                    <li class="offers_icons_item"><img
                                                            src="<c:url value="/resources/home/images/post.png" />" alt="">
                                                    </li>
                                                    <li class="offers_icons_item"><img
                                                            src="<c:url value="/resources/home/images/compass.png" />"
                                                            alt=""></li>
                                                    <li class="offers_icons_item"><img
                                                            src="<c:url value="/resources/home/images/bicycle.png" />"
                                                            alt=""></li>
                                                    <li class="offers_icons_item"><img
                                                            src="<c:url value="/resources/home/images/sailboat.png" />"
                                                            alt="">
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="button book_button"><a
                                                    href="/offers/${tour.tourId}">book<span></span><span></span><span></span></a></div>
                        ...
                        <div class="footer_content footer_about">
                            <div class="logo_container footer_logo">
                                <div class="logo"><a href="#"><img
                                        src="<c:url value="/resources/home/images/logo.png" />" alt="">travelix</a>
                                </div>
                            </div>
...
<script src="<c:url value="/resources/home/plugins/Isotope/isotope.pkgd.min.js" />"></script>
...
<script src="<c:url value="/resources/home/js/offers_custom.js" />"></script>
